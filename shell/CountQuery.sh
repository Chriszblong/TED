...
g++ -O3 e_count_query.cpp -o e_count_query
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					countFile="/home/yangkai/plt/query/count/"
					countFile+="${connectedFile[$i]}"
					countFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_count.txt"

					echo $countFile

					./e_count_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $countFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					./e_count_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $countFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					countFile="/home/yangkai/plt/query/count/"
					countFile+="${connectedFile[30]}"
					countFile+=".txt"
					countFile=${countFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_count.txt"
		...
		"entry")
			...
			then
				...
				do
					...
					countFile+="${connectedFile[31]}"
					countFile+=".txt"
					countFile=${countFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_count.txt"

					echo $countFile

					./e_count_query ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $countFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					countFile+="${connectedFile[30]}"
					countFile+=".txt"
					countFile=${countFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_count.txt"

					echo $countFile
					./e_count_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $countFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $countFile
					./e_count_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $countFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
