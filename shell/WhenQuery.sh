...
g++ -O3 e_when_query.cpp -o e_when_query
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					whenFile="/home/yangkai/plt/query/when/"
					whenFile+="${connectedFile[$i]}"
					whenFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_when.txt"

					echo $whenFile

					./e_when_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whenFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					./e_when_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whenFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					whenFile="/home/yangkai/plt/query/when/"
					whenFile+="${connectedFile[30]}"
					whenFile+=".txt"
					whenFile=${whenFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_when.txt"
		...
		"entry")
			...
			then
				...
				do
					...
					whenFile+="${connectedFile[31]}"
					whenFile+=".txt"
					whenFile=${whenFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_when.txt"

					echo $whenFile

					./e_when_query ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whenFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					whenFile+="${connectedFile[30]}"
					whenFile+=".txt"
					whenFile=${whenFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_when.txt"

					echo $whenFile
					./e_when_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whenFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $whenFile
					./e_when_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whenFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
