...
g++ -O3 e_t_ratio.cpp -o e_t_ratio
		...
		"length")
			...
			then
				...
				do
					...
					formatFile+=".txt"
					pcodingFile="/home/yangkai/plt/result/t_coding/"
					pcodingFile+="${formatFiles[$i]}"
					pcodingFile+=".txt"
					ratioFile="/home/yangkai/plt/ratio/t/"
					ratioFile+="${formatFiles[$i]}"
					ratioFile+=".txt"
					echo $ratioFile
					./e_t_ratio $formatFile $pcodingFile $ratioFile
				done
