...
g++ -O3 e_distance_single_query.cpp -o e_distance_single_query
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					distance_singleFile="/home/yangkai/plt/query/distance_single/"
					distance_singleFile+="${connectedFile[$i]}"
					distance_singleFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_distance_single.txt"

					echo $distance_singleFile

					./e_distance_single_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distance_singleFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					./e_distance_single_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distance_singleFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					distance_singleFile="/home/yangkai/plt/query/distance_single/"
					distance_singleFile+="${connectedFile[30]}"
					distance_singleFile+=".txt"
					distance_singleFile=${distance_singleFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_distance_single.txt"
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					distance_singleFile="/home/yangkai/plt/query/distance_single/"
					distance_singleFile+="${connectedFile[31]}"
					distance_singleFile+=".txt"
					distance_singleFile=${distance_singleFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_distance_single.txt"
		...
		"entry")
			...
			then
				...
				do
					...
					distance_singleFile+="${connectedFile[31]}"
					distance_singleFile+=".txt"
					distance_singleFile=${distance_singleFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_distance_single.txt"

					echo $distance_singleFile

					./e_distance_single_query ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distance_singleFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					distance_singleFile+="${connectedFile[30]}"
					distance_singleFile+=".txt"
					distance_singleFile=${distance_singleFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_distance_single.txt"

					echo $distance_singleFile
					./e_distance_single_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distance_singleFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $distance_singleFile
					./e_distance_single_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distance_singleFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
