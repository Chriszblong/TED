...
g++ -O3 e_where_query.cpp -o e_where_query
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					whereFile="/home/yangkai/plt/query/where/"
					whereFile+="${connectedFile[$i]}"
					whereFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_where.txt"

					echo $whereFile

					./e_where_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whereFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					./e_where_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whereFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					whereFile="/home/yangkai/plt/query/where/"
					whereFile+="${connectedFile[30]}"
					whereFile+=".txt"
					whereFile=${whereFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_where.txt"
		...
		"entry")
			...
			then
				...
				do
					...
					whereFile+="${connectedFile[31]}"
					whereFile+=".txt"
					whereFile=${whereFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_where.txt"

					echo $whereFile

					./e_where_query ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whereFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					whereFile+="${connectedFile[30]}"
					whereFile+=".txt"
					whereFile=${whereFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_where.txt"

					echo $whereFile
					./e_where_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whereFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $whereFile
					./e_where_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $whereFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
