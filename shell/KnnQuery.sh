...
g++ -O3 e_knn_query.cpp -o e_knn_query
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					e_knn_queryFile="/home/yangkai/plt/query/knn/"
					e_knn_queryFile+="${connectedFile[$i]}"
					e_knn_queryFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_knn.txt"

					echo $e_knn_queryFile

					./e_knn_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_knn_queryFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					./e_knn_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_knn_queryFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					e_knn_queryFile="/home/yangkai/plt/query/knn/"
					e_knn_queryFile+="${connectedFile[30]}"
					e_knn_queryFile+=".txt"
					e_knn_queryFile=${e_knn_queryFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_knn.txt"
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					e_knn_queryFile="/home/yangkai/plt/query/knn/"
					e_knn_queryFile+="${connectedFile[31]}"
					e_knn_queryFile+=".txt"
					e_knn_queryFile=${e_knn_queryFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_knn.txt"
		...
		"entry")
			...
			then
				...
				do
					...
					e_knn_queryFile+="${connectedFile[31]}"
					e_knn_queryFile+=".txt"
					e_knn_queryFile=${e_knn_queryFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_knn.txt"

					echo $e_knn_queryFile

					./e_knn_query ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_knn_queryFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					e_knn_queryFile+="${connectedFile[30]}"
					e_knn_queryFile+=".txt"
					e_knn_queryFile=${e_knn_queryFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_knn.txt"

					echo $e_knn_queryFile
					./e_knn_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_knn_queryFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $e_knn_queryFile
					./e_knn_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_knn_queryFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
