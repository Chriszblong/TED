...
g++ -O3 e_window_query_without_index.cpp -o e_window_query_without_index
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					e_window_query_without_indexFile="/home/yangkai/plt/query/window_without_index/"
					e_window_query_without_indexFile+="${connectedFile[$i]}"
					e_window_query_without_indexFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_window.txt"

					echo $e_window_query_without_indexFile

					./e_window_query_without_index ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_window_query_without_indexFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					./e_window_query_without_index ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_window_query_without_indexFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					e_window_query_without_indexFile="/home/yangkai/plt/query/window_without_index/"
					e_window_query_without_indexFile+="${connectedFile[30]}"
					e_window_query_without_indexFile+=".txt"
					e_window_query_without_indexFile=${e_window_query_without_indexFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_window.txt"
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					e_window_query_without_indexFile="/home/yangkai/plt/query/window_without_index/"
					e_window_query_without_indexFile+="${connectedFile[31]}"
					e_window_query_without_indexFile+=".txt"
					e_window_query_without_indexFile=${e_window_query_without_indexFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_window.txt"
		...
		"entry")
			...
			then
				...
				do
					...
					e_window_query_without_indexFile+="${connectedFile[31]}"
					e_window_query_without_indexFile+=".txt"
					e_window_query_without_indexFile=${e_window_query_without_indexFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_window.txt"

					echo $e_window_query_without_indexFile

					./e_window_query_without_index ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_window_query_without_indexFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					e_window_query_without_indexFile+="${connectedFile[30]}"
					e_window_query_without_indexFile+=".txt"
					e_window_query_without_indexFile=${e_window_query_without_indexFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_window.txt"

					echo $e_window_query_without_indexFile
					./e_window_query_without_index ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_window_query_without_indexFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $e_window_query_without_indexFile
					./e_window_query_without_index ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $e_window_query_without_indexFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
...
rm e_window_query_without_index
