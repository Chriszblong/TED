...
g++ -O3 e_window_query.cpp -o e_window_query
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					windowFile="/home/yangkai/plt/query/window/"
					windowFile+="${connectedFile[$i]}"
					windowFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_window.txt"

					echo $windowFile

					./e_window_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $windowFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					windowFile+="${connectedFile[$i]}"
					windowFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/singapore_window.txt"

					echo $windowFile

					./e_window_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $windowFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					windowFile="/home/yangkai/plt/query/window/"
					windowFile+="${connectedFile[30]}"
					windowFile+=".txt"
					windowFile=${windowFile/"threshold"/"threshold_${thresholdValue[$i]}"}

					windowresultFile="/home/yangkai/plt/query/window/result/"
					windowresultFile+="${connectedFile[30]}"
					windowresultFile+=".txt"
					windowresultFile=${windowresultFile/"threshold"/"threshold_${thresholdValue[$i]}"}

					queryset="/home/yangkai/plt/query/queryset/beijing_window.txt"

					echo $windowFile
					echo $windowresultFile
					./e_window_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $windowFile -1 $queryset ${entryNum[0]} $windowresultFile
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					windowFile="/home/yangkai/plt/query/window/"
					windowFile+="${connectedFile[31]}"
					windowFile+=".txt"
					windowFile=${windowFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					windowresultFile="/home/yangkai/plt/query/window/result/"
					windowresultFile+="${connectedFile[31]}"
					windowresultFile+=".txt"
					windowresultFile=${windowresultFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_window.txt"

					echo $windowFile
					./e_window_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $windowFile -1 $queryset ${entryNum[0]} $windowresultFile
				done
			else
				for i in {0..5}
				do
		...
		"entry")
			...
			then
				...
				do
					...
					windowFile+="${connectedFile[31]}"
					windowFile+=".txt"
					windowFile=${windowFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_window.txt"

					echo $windowFile

					./e_window_query ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $windowFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					windowFile+="${connectedFile[30]}"
					windowFile+=".txt"
					windowFile=${windowFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_window.txt"

					echo $windowFile
					./e_window_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $windowFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $windowFile
					./e_window_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $windowFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
