...
g++ -O3 e_distance_query.cpp -o e_distance_query
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					distanceFile="/home/yangkai/plt/query/distance/"
					distanceFile+="${connectedFile[$i]}"
					distanceFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_distance.txt"

					echo $distanceFile

					./e_distance_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distanceFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					./e_distance_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distanceFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					distanceFile="/home/yangkai/plt/query/distance/"
					distanceFile+="${connectedFile[30]}"
					distanceFile+=".txt"
					distanceFile=${distanceFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_distance.txt"
		...
		"entry")
			...
			then
				...
				do
					...
					distanceFile+="${connectedFile[31]}"
					distanceFile+=".txt"
					distanceFile=${distanceFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_distance.txt"

					echo $distanceFile

					./e_distance_query ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distanceFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					distanceFile+="${connectedFile[30]}"
					distanceFile+=".txt"
					distanceFile=${distanceFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_distance.txt"

					echo $distanceFile
					./e_distance_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distanceFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $distanceFile
					./e_distance_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $distanceFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
