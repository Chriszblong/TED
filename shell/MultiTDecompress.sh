	...
	case "$args" in
		"length")
			...
			then
				for i in {5..9}
				do
					tcompressFile="/home/yangkai/plt/result/multit_coding/"
					tcompressFile+="${formatedFile[$i]}"
					tcompressFile+=".txt"
					multitdecompressFile="/home/yangkai/plt/decompress/multit/"
					multitdecompressFile+="${formatedFile[$i]}"
					multitdecompressFile+=".txt"
					timeFile="/home/yangkai/plt/recording/multitdecompress/"
					timeFile+="${formatedFile[$i]}"
					timeFile+=".txt"
					echo $multitdecompressFile
					./e_matrix_decompress $tcompressFile $multitdecompressFile $timeFile 1 5
				done
		...
		"threshold")
			...
			then
				tcompressFile="/home/yangkai/plt/result/multit_coding/"
				tcompressFile+="${formatedFile[30]}"
				tcompressFile+=".txt"

				multitdecompressFile="/home/yangkai/plt/decompress/multit/"
				multitdecompressFile+="${formatedFile[30]}"
				multitdecompressFile+=".txt"
				timeFile="/home/yangkai/plt/recording/multitdecompress/"
			...
			then
				tcompressFile="/home/yangkai/plt/result/multit_coding/"
				tcompressFile+="${formatedFile[31]}"
				tcompressFile+=".txt"

				multitdecompressFile="/home/yangkai/plt/decompress/multit/"
				multitdecompressFile+="${formatedFile[31]}"
				multitdecompressFile+=".txt"
				timeFile="/home/yangkai/plt/recording/multitdecompress/"
		...
		"entry")
			...
			then
				...
				do
					...
					tcompressFile+="${formatedFile[31]}"
					tcompressFile+=".txt"
					tcompressFile=${tcompressFile/"threshold"/"entry_${entryNum[$i]}"}

					multitdecompressFile="/home/yangkai/plt/decompress/multit/"
					multitdecompressFile+="${formatedFile[31]}"
					multitdecompressFile+=".txt"
					multitdecompressFile=${multitdecompressFile/"threshold"/"entry_${entryNum[$i]}"}
					timeFile="/home/yangkai/plt/recording/multitdecompress/"
					timeFile+="${formatedFile[$i]}"
					timeFile+=".txt"
