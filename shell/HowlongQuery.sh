...
g++ -O3 e_howlong_query.cpp -o e_howlong_query
		...
		"length")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					howlongFile="/home/yangkai/plt/query/howlong/"
					howlongFile+="${connectedFile[$i]}"
					howlongFile+=".txt"
					queryset="/home/yangkai/plt/query/queryset/beijing_howlong.txt"

					echo $howlongFile

					./e_howlong_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $howlongFile -1 $queryset ${entryNum[0]}
				done
			...
			then
				...
				do
					...
					./e_howlong_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $howlongFile -1 $queryset ${entryNum[0]}
				done
			else
				for i in {5..9}
				do
		...
		"threshold")
			...
			then
				...
				do
					...
					intervalFile+=".txt"
					howlongFile="/home/yangkai/plt/query/howlong/"
					howlongFile+="${connectedFile[30]}"
					howlongFile+=".txt"
					howlongFile=${howlongFile/"threshold"/"threshold_${thresholdValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_howlong.txt"
		...
		"entry")
			...
			then
				...
				do
					...
					howlongFile+="${connectedFile[31]}"
					howlongFile+=".txt"
					howlongFile=${howlongFile/"threshold"/"entry_${entryNum[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/singapore_howlong.txt"

					echo $howlongFile

					./e_howlong_query ${nodeFile[1+$i]} ${edgeFile[1+$i]} ${geoFile[1+$i]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $howlongFile -1 $queryset ${entryNum[$i]}
				done
			fi
			;;
		"deep")
			...
			then
				...
				do
					...
					howlongFile+="${connectedFile[30]}"
					howlongFile+=".txt"
					howlongFile=${howlongFile/"threshold"/"deep_${deepValue[$i]}"}
					queryset="/home/yangkai/plt/query/queryset/beijing_howlong.txt"

					echo $howlongFile
					./e_howlong_query ${nodeFile[0]} ${edgeFile[0]} ${geoFile[0]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $howlongFile ${deepValue[$i]} $queryset ${entryNum[0]}
			...
			then
				...
				do
					...
					echo $howlongFile
					./e_howlong_query ${nodeFile[1]} ${edgeFile[1]} ${geoFile[1]} $pddpindexFile $partitionindexFile $pcodingFile $lcodingFile $tcodingFile $intervalFile $howlongFile ${deepValue[$i]} $queryset ${entryNum[0]}
				done
			else
				for i in {0..4}
				do
