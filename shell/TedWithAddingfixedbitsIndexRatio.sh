		...
		"length")
			...
			then
				...
				do
					...
					pcodingFile+=".txt"
					lcodingFile="/home/yangkai/plt/result/addfixbits_coding/"
					lcodingFile+="${formatFiles[$i]}"
					lcodingFile+=".txt"
					tcodingFile="/home/yangkai/plt/result/t_coding/"
					tcodingFile+="${formatFiles[$i]}"
					tcodingFile+=".txt"
					ratioFile="/home/yangkai/plt/ratio/ted_addfixbits_index/"
					ratioFile+="${formatFiles[$i]}"
					ratioFile+=".txt"
					echo $ratioFile
					./e_ted_ratio $formatFile $pcodingFile $lcodingFile $tcodingFile $ratioFile 1
				done
